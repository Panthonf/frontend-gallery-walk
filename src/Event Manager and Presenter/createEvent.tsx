...
import { IconArrowLeft, IconArrowRight, IconArrowsDiagonal, IconClock, IconPhotoUp, IconPhotoX } from "@tabler/icons-react";
    ...
    return (
        ...
        >
            ...
            >
                <div>
                    {/* register container */}
                    <Stepper active={active} onStepClick={changeStep}
                        color="redcolor.4"
                        size="sm"
                        iconSize={32}
                    >
                                                    ...
                                                    {previews.length > 0 ? (
                                                            ...
                                                            <Text size="xl" inline>
                                                                ...
                                                                >
                                                                    {previews.length > 0 && (
                                                                        ...
                                                                        <div>
                                                                            <Text size="base" c="deepredcolor.9" fw={500} mb="md">
                                                                                Preview
                                                                            </Text>
                                                        ...
                                                        <div>
                                                            ...
                                                            <Text c="graycolor.2" inline mt="1rem">
                                                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorem aliquam aspernatur est harum.
                                                            </Text>
                                                        </div>
                                                    )}
                                ...
                                >
                                    <Grid.Col span="content">
                                        <Calendar
                                            ...
                                            static
                                            renderDay={(date) => {
                                                const startDate = form.getInputProps("startDateEvent").value;
                                                const endDate = form.getInputProps("endDateEvent").value;

                                                const isInRange = startDate && endDate && date >= startDate && date <= endDate;

                                                return (
                                                    <Indicator size={6} color={isInRange ? "redcolor.4" : "transparent"} offset={-2}>
                                    ...
                                    <Grid.Col span="auto">
                                        ...
                                        <Text mb="xs">
                                            <Text span fw={500}>Event Name: </Text>
                                            {form.values.eventName.toString()}
                                        </Text>

                                        <Text mb="xs">
                                            <div>
                                                <Text span fw={500}>Start event date: {" "}</Text>
                                                <Text span c="redcolor.4" mx="xs">{moment(form.values.startDateEvent).format("LL")}</Text>{" at "}
                                                <Text span c="redcolor.4" mx="xs">{moment(form.values.startTimeEvent, "HH:mm").format("hh:mm A")}</Text>
                                            </div>
                                            <div>
                                                <Text span fw={500}>End event date: {" "}</Text>
                                                <Text span c="redcolor.4" mx="xs">{moment(form.values.endDateEvent).format("LL")}</Text>{" at "}
                                                <Text span c="redcolor.4" mx="xs">{moment(form.values.endTimeEvent, "HH:mm").format("hh:mm A")}</Text>
                                            </div>
                                        </Text>
                                        ...
                                        <Modal opened={opened} onClose={close} title="Description" centered
                                            radius="xs" size="75%" padding="lg" className={styles.scrollBar}
                                        >
                                ...
                                <Flex justify="space-between">
                                    ...
                                    >
                                        <Grid.Col span="content">
                                            <Calendar
                                                ...
                                                static
                                                renderDay={(date) => {
                                                    const startDate = form.getInputProps("startDateProject").value;
                                                    const endDate = form.getInputProps("endDateProject").value;
                                                    const isInRange = startDate && endDate && date >= startDate && date <= endDate;
                                                    return (
                                                        <Indicator size={6} color={isInRange ? "deepredcolor.9" : "transparent"} offset={-2}>
                                                            <div>{date.getDate()}</div>
                                                        </Indicator>
                                                    );
                                                }}
                                        ...
                                        <Grid.Col span="auto">
                                            ...
                                            <Text mb="xs">
                                                <div>
                                                    <Text span fw={500}>Start submit date: {" "}</Text>
                                                    <Text span c="deepredcolor.4" mx="xs">{moment(form.values.startDateEvent).format("LL")}</Text>{" at "}
                                                    <Text span c="deepredcolor.4" mx="xs">{moment(form.values.startTimeEvent, "HH:mm").format("hh:mm A")}</Text>
                                                </div>
                                                <div>
                                                    <Text span fw={500}>End submit date: {" "}</Text>
                                                    <Text span c="deepredcolor.4" mx="xs">{moment(form.values.endDateEvent).format("LL")}</Text>{" at "}
                                                    <Text span c="deepredcolor.4" mx="xs">{moment(form.values.endTimeEvent, "HH:mm").format("hh:mm A")}</Text>
                                                </div>
                                            </Text>
                                        </Grid.Col>
                                    </Grid>
                                    ...
                                    >
                                        ...
                                        <Grid.Col span={12}>
                                            ...
                                            <Text mb="xs">
                                                <div>
                                                    <Text span fw={500}>Virtual money: {" "}</Text>
                                                    <Text span c="pinkcolor.2" mx="xs">{form.values.virtualMoney}</Text>{" Unit "}
                                                    <Text span c="pinkcolor.2" mx="xs">{form.values.unit}</Text>
                                                </div>

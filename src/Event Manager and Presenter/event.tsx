...
export default function Event() {
    ...
    useEffect(() => {
        ...
        const generateQRCode = async () => {
            try {
                const url = `${import.meta.env.VITE_BASE_ENDPOINTMENT
                    }presenters/${eventId}`;
    ...
    const ModalThumbnail = () => {
        ...
        return (
            <>
                <Modal opened={opened} onClose={close} title="Authentication" size="90%" centered>
                                        ...
                                        <Menu.Dropdown>
                                            ...
                                            >
                                                <Anchor
                                                    ...
                                                    c="bluecolor.4"
                                                >
                                                    Link for <Text span c="bluecolor.4" fw="600" inherit>Presenter</Text>
                                                </Anchor>
                                            </Menu.Item>
                                            ...
                                            >
                                                <Anchor
                                                    ...
                                                    c="greencolor.4"
                                                >
                                                    Link for <Text span c="greencolor.4" fw="600" inherit>Guest</Text>
                                                </Anchor>
                                            </Menu.Item>

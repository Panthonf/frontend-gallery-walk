            ...
            try {
                await axios
                    ...
                    .then((res) => {
                        ...
                        const commentsWithAnonymousNames = res.data.data.map((comment: CommentType) => ({
                            ...comment,
        ...
        return (
            ...
            >
                ...
                <Group align="flex-end" gap="xs" mt={25}>
                    <Text fw={500} c="bluecolor.4">{stat.value}</Text>
                </Group>
                    ...
                    {project?.description && (
                        <div>
                            ...
                            <Modal opened={opened} onClose={close} title="Description" centered
                                radius="xs" size="80%" padding="lg" className={styles.scrollBar}
                            >
                                <div
                                    dangerouslySetInnerHTML={{
                                        __html: DOMPurify.sanitize(project?.description),
    ...
    return (
        <body>
                    ...
                    <div>
                        <Affix position={{ top: 90, left: 20 }}>
                            <a href="/dashboard">
                                <Button
                                    size="xs"
                                    leftSection={<IconArrowLeft size={14} color="var(--bluecolor)" />}
                                    color="bluecolor.4"
                                >
                                ...
                                <div>
                                    ...
                                    <Flex mb="md" gap="2rem">
                                        <div>
                                            ...
                                            <Text>
                                                {moment(project?.start_submit).format(
                                                    "LL [at] HH:mm A"
                                                )}
                                            </Text>
                                        </div>
                                        <div>
                                            ...
                                            <Text>
                                                {moment(project?.end_submit).format(
                                                    "LL [at] HH:mm A"
                                                )}
                                            </Text>
                                        </div>
                        ...
                        <Card className={`${styles.cardContainer} ${styles.presenter}`} mx="auto" w="80%">
                            <Grid>
                                <Grid.Col span={4}>
                                    <Grid>
                                        <Grid.Col span={4}>
                                ...
                                <>
                                    {Array.isArray(comment) && comment.length !== 0 ? (
                                        comment.map((comment: CommentType) => (
                                            <Card shadow="lg" mt="lg" className={`${styles.commentContainer} ${styles.presenter}`}>
                                                <Grid key={comment.id} gutter="md">
                                                    ...
                                                    <Grid.Col span={1} ta="end">
                                                        <Text c="graycolor.2" size="small"># {comment.id}</Text>
                                                    </Grid.Col>
                                                </Grid>
                                            </Card>
                                        ))
                                ...
                                <>
                                    <Center h="20rem">
                                        <div style={{ textAlign: "center" }}>
                                            ...
                                            <Box bg="bluecolor.1" w="max-content" mx="auto" mt="md" p="0.5rem" style={{ borderRadius: "0.2rem" }}>
            ...
            <Affix className={` ${styles.footer} ${styles.presenter}`}>
                <Center h="1.5rem">
                    <Text c="bluecolor.1" size="small" ta="center">Presenter</Text>
                </Center>
            </Affix>

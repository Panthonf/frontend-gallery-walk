...
export default function ProjectsDashboard() {
  ...
  const card =
    ...
    projects.map((projects: ProjectType) => {
      const thumbnailUrl =
        projects.project_image[0]?.project_image_url ||
          ...
          >
            ...
            <Card.Section>
              <Flex justify="space-between">
                <Box w="75%">
                  <Text size="topic" c="bluecolor.4" fw={600} truncate="end">
                    {projects.title}
                  </Text>
                </Box>
                ...
                <Flex gap="xs" align="center">
                  <HoverCard width={280} shadow="md">
                    ...
                    <HoverCard.Dropdown w="max-content" bg="var(--whitecolor)">
                      {(projects.event_data as { location: string })?.location
                        ? (
                            projects.event_data as {
                              location: string;
                            }
              ...
              <Flex justify="flex-start" gap="2rem">
                ...
                <div>
                  ...
                  <Text size="small" c="graycolor.2">
                    {moment(projects.created_at).format("LL [at] HH:mm")}
                  </Text>
                </div>
              </Flex>
      ...
      <Grid>
        ...
        <Grid.Col span={6}>
          <Flex gap="lg" justify="end">
            ...
            <Modal opened={opened} onClose={close} title="Join event" centered>
              <Box ta="end">
                <TextInput
          ...
          {isLoading && (
            <Center>
              <Affix position={{ top: "50%", left: "50%" }}>
                <Loader color="bluecolor.4" type="dots" size={50} />
              </Affix>
            </Center>
          )}

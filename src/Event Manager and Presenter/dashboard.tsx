        ...
        >
          ...
          <Card.Section>
            <Flex justify="space-between">
              <Box w="75%">
                <Text size="topic" c="redcolor.4" fw={600} truncate="end">
                  {event.event_name}
                </Text>
              </Box>
  ...
  return (
    <body>
                  ...
                  {isLoading && (
                    <Center>
                      <Affix position={{ top: "50%", left: "50%" }}>
                        <Loader type="dots" mt="lg" size={40} color="redcolor.4" />
                      </Affix>
                    </Center>
                  )}
      ...
      <Affix
        ...
        bg={activeTab === "Presenter" ? "bluecolor.4" : "redcolor.4"}
      >
        <Center h="1.5rem">
          <Text
            c={activeTab === "Presenter" ? "white" : "white"}
            size="small"
            ta="center"
          >
